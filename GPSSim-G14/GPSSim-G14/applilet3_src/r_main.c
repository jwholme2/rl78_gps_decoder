...
void main(void)
{
    ...
    /* Start interval timer (for RTC_Scheduler) */
    R_IT_Start(); 		
    ...
    //Add Task_NMEA_Decode to scheduler
    //Period of 0 means this is event-driven
    Add_Task(Task_NMEA_Decode, 0, 1);
    Add_Task(Task_GPS_LCD_Update, 0, 2); 
    Add_Task(Task_Clock_LCD_Update, RTC_FREQ_TO_TICKS(10), 3);
    //Add_Task(Task_Transmit, RTC_FREQ_TO_TICKS(1), 4);
    Add_Task(Task_SW1, 0, 4);
